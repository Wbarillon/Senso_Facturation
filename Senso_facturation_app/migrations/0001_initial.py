# Generated by Django 3.1 on 2020-11-30 10:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_service_produit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='service_produit_commande', to='Senso_facturation_app.service_produit', verbose_name='Service commandé')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_taxe', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='taxe_service_produit_commande', to='Senso_facturation_app.taxe', verbose_name='Taxe Service/Produit Commandé')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('id_service_produit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='taxe_service_produit', to='Senso_facturation_app.service_produit', verbose_name='Service/produit')),
                ('id_taxe', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='taxe_service_produit', to='Senso_facturation_app.taxe', verbose_name='Taxe Service/Produit')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_personne', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='facture_personne', to='Senso_facturation_app.personne', verbose_name='Identifiant Personne')),
            ],
        ),
    ]
